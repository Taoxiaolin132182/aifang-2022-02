...
'''需要配置的参数'''
config_choose_for_arm = 2  # ARM编号： 1 or 2
sys_num = 0  # windows: 0 || linux: 1
bool_unlock = [False, 180, None, []]  # [全局开关，时间限制，时间戳，登录IP]
if_use_1 = 0
...
def instructions_t1(request):
    global index_mes1, config_choose_for_arm
    list_for_parameter = ["36.07", "36.07"]  # 传送带速度比率参数[高处，低处](一般是相同的，但有不同的情况(河南盛泰1.1))
