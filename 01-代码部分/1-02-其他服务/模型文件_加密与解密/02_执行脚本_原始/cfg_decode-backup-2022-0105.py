...
path_job = "/mnt/data/data/aimodel/wxmf_sansimian_20210816_cleanzm/"  # 三丝棉 clean 模型
# path_job = "/mnt/data/data/aimodel/"  # 老模型

# path_model = ""   # 老模型
path_model = "trt_model/model_atss_detection/1/"   # 三丝棉 模型
...
model_last_name = ["model.des3", "model.plan"]  # 三丝棉 模型
