# coding=utf-8
'''(2022-01-24) - (试生产1.1B-NO.3) - (4抓手) - (ARM2) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 2  # ARM 2号
Path_upload = "ssc_1.1B_arm2_"  # 上传图片路径标记
...
X1_LEN1 = [316, 316, 316]             # 抓手1的X轴距离补偿
Y1_LEN1 = [517, 517, 517]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.46, 0.46, 0.46]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [300, 300, 300]             # 抓手2的X轴距离补偿
Y2_LEN1 = [1142, 1142, 1142]       # 抓手2的Y轴距离补偿
T2_LEN1 = [0.46, 0.46, 0.46]       # 抓手2的下抓时间补偿

X3_LEN1 = [285, 285, 285]              # 抓手3的X轴距离补偿
Y3_LEN1 = [1562, 1562, 1562]     # 抓手3的Y轴距离补偿
T3_LEN1 = [0.46, 0.46, 0.46]        # 抓手3的下抓时间补偿

X4_LEN1 = [295, 295, 295]               # 抓手4的X轴距离补偿
Y4_LEN1 = [2187, 2187, 2187]      # 抓手4的Y轴距离补偿
...
Camera_id = [["36124442", "A", "1"],
             ["36124441", "C", "2"],
             ["43124229", "B", "3"]]  # 试生产1.1B--ARM2 对应相机号
...
PLC_ip_second = '192.168.1.114'  # 第二抓取模组  --ssc-1.1-0915
