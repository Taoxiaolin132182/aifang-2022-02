...
alias af-modify='sudo python3 /mnt/data/data/2test_remove/modify_config/manage.py runserver 0.0.0.0:8686'
alias af-modify-m='sudo touch /opt/logs/txl01/modify.log'
alias af-modify-ch='sudo chmod 777 /opt/logs/txl01/modify.log'
