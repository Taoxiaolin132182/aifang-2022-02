# coding=utf-8
'''(2022-02-22) - (张家港天宇1.1-老版本) - (2抓手) - (ARM1) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 1  # ARM 1号
Path_upload = "zjgty_old1.1_arm1_"  # 上传图片路径标记
Code_version = 4.2
...
Y1_LEN1 = [1641.5, 1641.5, 1641.5]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.3, 0.3, 0.3]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [213, 213, 213]             # 抓手2的X轴距离补偿
Y2_LEN1 = [2261.5, 2261.5, 2261.5]       # 抓手2的Y轴距离补偿
T2_LEN1 = [0.3, 0.3, 0.3]       # 抓手2的下抓时间补偿
...
#              ["35024020", "C", "2"],
#              ["39024088", "B", "3"]]  # 张家港1.1-ARM1 对应相机号
