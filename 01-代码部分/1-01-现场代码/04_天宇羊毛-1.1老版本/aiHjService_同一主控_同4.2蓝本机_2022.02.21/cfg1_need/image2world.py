...
'''tianyu_2020_11_13_ARM1'''
'''X总长684.6mm,Y总长580mm,AB之间图像重合77.6mm,BC之间图像重合88.1mm'''
...
'''AB距离607mm，BC距离596.5mm(由3颗相机拍一组卷尺换算长度得到数据（x=1224时的卷尺读数差）)'''
pxy_add1 = [[156, 500], [1331.5, 503.5], [750, 488]]  # 与支架前部内框点（近电柜处）某一个固定点距离 #123 -acb
