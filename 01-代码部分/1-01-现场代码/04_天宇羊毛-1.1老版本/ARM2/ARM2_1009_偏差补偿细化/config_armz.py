...
MELSEC_SERVER_IP = '192.168.1.252'
MELSEC_SERVER_PORT = 10002

# 摄像头参数
CAMERA_CTRL_WIDTH = 2448
CAMERA_CTRL_HEIGHT = 2048
CAMERA_DEVICE_TUPLE = ("35024027", "35024015", "35024028")
CAMERA_DEVICE_POSITION_MAP = {"35024027":"1","35024015":"2","35024028":"3"}
CAMERA_SAVE_IMAGE = {"35024027": "A", "35024015": "C", "35024028": "B"}#左A右C中B
...
Choose_type = [["yixian"],["yixian", "shenhuangmao"],["yixian", "shenhuangmao", "zhonghuangmao"]]
# 传送带速度
...
X1_LEN1 = [10, 10, 10]                   # 抓手1的X轴距离补偿
Y1_LEN1 = [482.5, 482.5, 482.5]       # 抓手1的Y轴距离补偿
T1_LEN1 = [0.01, 0.01, 0.01]          # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [15, 15, 15]             # 抓手2的X轴距离补偿
Y2_LEN1 = [532.5, 532.5, 532.5]       # 抓手2的Y轴距离补偿
T2_LEN1 = [0.23, 0.23, 0.23]       # 抓手2的下抓时间补偿
