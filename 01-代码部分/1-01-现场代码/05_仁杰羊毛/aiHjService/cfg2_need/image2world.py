...
pxy_add1 = [[1382 - 10, 264 + 35], [179-20, 294], [754, 264 + 30]]#与支架前部内框点（近电柜处）某一个固定点距离
# pxy_add1 = [[0,0],[0,0],[0,0]]#与支架前部内框点（近电柜处）某一个固定点距离
pxy_add1_a = [1820 + 215 -11.8, 740]#支架与抓手1单位距离(90,820) + 210 是因为Y轴相反：Y=210-y
