...
'''claw-1.1--2021-03-19-ARM1'''
'''X总长733mm,Y总长(612mmmm)'''
'''镜头到传送带的距离为734，提高60mm标定，实际工作距离674mm,'''
'''相机ACB排布，3颗相机对应的坐标系与PLC抓手X反向，Y同向'''
'''B点世界（0，0）像素坐标对应点，，到与支架前部内框点（近电柜处）某一个固定点距离（754,264）'''
'''B(925) A(1553) C(350)图中（1224，1024）对应的X值'''
'''(由3颗相机拍一组卷尺换算长度得到数据（x=1224时的卷尺读数差）)'''
pxy_add1 = [[1382 + 20, 264], [179 - 30, 264], [754 + 10, 264]]  # 与支架前部内框点（近电柜处）某一个固定点距离 #123 -acb
