...
'''试生产1.1B-Frist--2022-01-20-ARM2'''
'''X总长735mm,Y总长(600mm)'''
'''镜头到传送带的距离为703，提高30mm标定，实际工作距离673mm,'''
'''相机ACB排布，3颗相机对应的坐标系与PLC抓手X反向，Y同向'''
'''B点世界（0，0）像素坐标对应点，，到与支架前部内框点（近电柜处）某一个固定点距离（1060,305）'''
'''A(1514) B(909) C(302)图中（1224，1024）对应的X值'''
'''(由3颗相机拍一组卷尺换算长度得到数据（x=1224时的卷尺读数差）)'''
pxy_add1 = [[455,305], [1667,305], [1060,305]]  # 与支架前部内框点（近电柜处）某一个固定点距离 #123 -acb
