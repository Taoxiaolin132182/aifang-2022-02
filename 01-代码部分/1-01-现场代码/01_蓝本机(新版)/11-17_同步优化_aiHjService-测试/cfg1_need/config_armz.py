# coding=utf-8
'''(2021-08-18) - (试生产-1.2) - (4抓手) - (ARM1) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 1  # ARM 1号
Path_upload = "ssc_1.2_arm1_"  # 上传图片路径标记
...
#              ["48024039", "B", "2"]]  # 试生产1.2-ARM1 对应相机号
