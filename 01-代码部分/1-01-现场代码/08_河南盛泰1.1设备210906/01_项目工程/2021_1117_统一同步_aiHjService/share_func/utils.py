...
def test_sql_write():
    ...
    list_1 = [1, 2, 251.542, 2000, 2000, 1000, 1000, 542, 234, 5, "zangmian", 0.75, 1, "red", "bomo"]
    list_2 = [12, time.time(), "grab_error"]
    list_4 = ["dsswe1323", "sdf2#ff"]
    list_5 = [list_4[0] + "_" + list_4[1], time_now_1, 1]
    list_6 = [3423, "/mnt/data/data/image/nobox/2021_0331/", time_now_1, 1]
