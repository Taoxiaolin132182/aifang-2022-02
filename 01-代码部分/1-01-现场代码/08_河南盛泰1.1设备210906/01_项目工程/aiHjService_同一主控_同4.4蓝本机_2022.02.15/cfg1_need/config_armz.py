# coding=utf-8
'''(2021-12-13) - (盛泰1.1-NO.2) - (2抓手) - (ARM1) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 1  # ARM 1号
Path_upload = "st_1.1_arm1_"  # 上传图片路径标记
...
X1_LEN1 = [270, 245, 270]             # 抓手1的X轴距离补偿
Y1_LEN1 = [600, 600, 600]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.6, 0.6, 0.6]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [245, 235, 255]             # 抓手2的X轴距离补偿
Y2_LEN1 = [1185, 1195, 1165]       # 抓手2的Y轴距离补偿
...
Camera_id = [["30124932", "A", "1"],
             ["30124934", "C", "2"],
             ["35024021", "B", "3"]]  # 盛泰1.1-UV-ARM1 对应相机号
