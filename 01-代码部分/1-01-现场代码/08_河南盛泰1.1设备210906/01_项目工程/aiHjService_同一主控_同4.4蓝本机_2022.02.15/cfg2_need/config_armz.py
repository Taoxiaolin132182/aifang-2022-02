# coding=utf-8
'''(2021-12-13) - (盛泰1.1-NO.2) - (2抓手) - (ARM2) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 2  # ARM 2号
Path_upload = "st_1.1_arm2_"  # 上传图片路径标记
...
X1_LEN1 = [235, 235, 235]             # 抓手1的X轴距离补偿
Y1_LEN1 = [870, 870, 870]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.6, 0.6, 0.6]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [235, 235, 235]             # 抓手2的X轴距离补偿
Y2_LEN1 = [1480, 1480, 1480]       # 抓手2的Y轴距离补偿
T2_LEN1 = [0.6, 0.6, 0.6]       # 抓手2的下抓时间补偿
...
Speed_of_csd = 380  # 传送带速度 600mm/s(预设)
Speed_rate = 0.0657  # 传送带速度比率：试生产1.1  25hz -2021-0928
...
Camera_id = [["30124935", "A", "1"],
             ["30124942", "C", "2"],
             ["30125170", "B", "3"]]  # 盛泰1.1-UV-ARM2 对应相机号
...
PLC_ip_frist = '192.168.1.113'  # 第一抓取模组  --ssc-1.1-0915
