# coding=utf-8
'''(2021-11-10) - (试生产-1.2B) - (4抓手分段) - (ARM2) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 2  # ARM 2号
Path_upload = "wxyf_1.2B_arm2_"  # 上传图片路径标记
...
X1_LEN1 = [323, 323, 0]             # 抓手1的X轴距离补偿
Y1_LEN1 = [545, 545, 0]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.3, 0.3, 0]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [-519, -519, 0]             # 抓手2的X轴距离补偿
Y2_LEN1 = [1200, 1200, 0]       # 抓手2的Y轴距离补偿
T2_LEN1 = [0.36, 0.36, 0]       # 抓手2的下抓时间补偿

X3_LEN1 = [333, 333, 0]              # 抓手3的X轴距离补偿
Y3_LEN1 = [1555, 1555, 0]     # 抓手3的Y轴距离补偿
T3_LEN1 = [0.3, 0.3, 0]        # 抓手3的下抓时间补偿

X4_LEN1 = [-515, -515, 0]               # 抓手4的X轴距离补偿
Y4_LEN1 = [2175, 2175, 0]      # 抓手4的Y轴距离补偿
T4_LEN1 = [0.3, 0.3, 0]         # 抓手4的下抓时间补偿
...
Camera_id = [["39024072", "A", "1"],
             ["48024048", "B", "2"]]  # 试生产1.2B-ARM2 对应相机号
...
PLC_ip_frist = '192.168.1.123'  # 第一抓取模组  --ssc-1.2
PLC_ip_second = '192.168.1.124'  # 第二抓取模组  --ssc-1.2
