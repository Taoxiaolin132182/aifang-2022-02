...
Y1_LEN1 = [530, 530, 0]        # 抓手1的Y轴距离补偿
T1_LEN1 = [0.5, 0.5, 0]        # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [-504, -504, 0]      # 抓手2的X轴距离补偿
Y2_LEN1 = [1160, 1160, 0]        # 抓手2的Y轴距离补偿
T2_LEN1 = [0.5, 0.5, 0]        # 抓手2的下抓时间补偿

X3_LEN1 = [333, 333, 0]         # 抓手3的X轴距离补偿
Y3_LEN1 = [1540, 1540, 0]       # 抓手3的Y轴距离补偿
T3_LEN1 = [0.5, 0.5, 0]         # 抓手3的下抓时间补偿

X4_LEN1 = [-500, -500, 0]       # 抓手4的X轴距离补偿
Y4_LEN1 = [2160, 2160, 0]       # 抓手4的Y轴距离补偿
