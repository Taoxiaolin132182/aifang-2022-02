...
'''claw-1.2--2021-11-09-ARM1'''
'''X总长745mm,Y总长(625mm),AB相机实体之间距离mm'''
'''镜头到传送带的距离为730，提高30mm标定，实际工作距离700mm'''
'''相机AB排布，3颗相机对应的坐标系与PLC抓手X反向，Y同向'''
'''B点世界（0，0）像素坐标对应点，，到与支架前部内框点（近电柜处）某一个固定点距离（510, 273）'''
'''A(843) B(361) C()图中（1224，1024）对应的X值'''
'''AB距离482mm，--重合263mm，BC距离mm(由3颗相机拍一组卷尺换算长度得到数据（x=1224时的卷尺读数差）)'''
pxy_add1 = [[210, 273], [692, 273], [123, 123]]  # 与支架前部内框点（近电柜处）某一个固定点距离 #123 -acb
