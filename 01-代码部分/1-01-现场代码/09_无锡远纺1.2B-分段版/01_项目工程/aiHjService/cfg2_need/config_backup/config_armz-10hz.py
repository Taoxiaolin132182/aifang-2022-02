...
'''此模块特征(不同主机，会有不同)'''
ARM_number = 2  # ARM 1号
Path_upload = "ssc_1.2FD_arm2_"  # 上传图片路径标记
...
T1_LEN1 = [0.43, 0.43, 0]        # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [-519, -519, 0]      # 抓手2的X轴距离补偿
Y2_LEN1 = [1175, 1175, 0]        # 抓手2的Y轴距离补偿
T2_LEN1 = [0.46, 0.46, 0]        # 抓手2的下抓时间补偿

X3_LEN1 = [333, 333, 0]         # 抓手3的X轴距离补偿
Y3_LEN1 = [1555, 1555, 0]       # 抓手3的Y轴距离补偿
T3_LEN1 = [0.46, 0.46, 0]         # 抓手3的下抓时间补偿

X4_LEN1 = [-500, -500, 0]       # 抓手4的X轴距离补偿
Y4_LEN1 = [2175, 2175, 0]       # 抓手4的Y轴距离补偿
T4_LEN1 = [0.46, 0.46, 0]         # 抓手4的下抓时间补偿
