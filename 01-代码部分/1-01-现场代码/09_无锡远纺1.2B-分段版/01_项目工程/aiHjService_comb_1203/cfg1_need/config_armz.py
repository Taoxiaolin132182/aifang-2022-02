# coding=utf-8
'''(2021-11-08) - (试生产-1.2) - (4抓手分段) - (ARM1) 模组配置'''
...
Y1_LEN1 = [745, 745, 0]        # 抓手1的Y轴距离补偿
T1_LEN1 = [0.32, 0.32, 0]        # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [-540, -540, 0]      # 抓手2的X轴距离补偿
Y2_LEN1 = [1375, 1375, 0]        # 抓手2的Y轴距离补偿
T2_LEN1 = [0.29, 0.29, 0]        # 抓手2的下抓时间补偿

X3_LEN1 = [330, 330, 0]         # 抓手3的X轴距离补偿
Y3_LEN1 = [1760, 1760, 0]       # 抓手3的Y轴距离补偿
T3_LEN1 = [0.24, 0.24, 0]         # 抓手3的下抓时间补偿

X4_LEN1 = [-510, -510, 0]       # 抓手4的X轴距离补偿
Y4_LEN1 = [2390, 2390, 0]       # 抓手4的Y轴距离补偿
T4_LEN1 = [0.24, 0.24, 0]         # 抓手4的下抓时间补偿

Speed_of_csd = 360  # 传送带速度 600mm/s(预设)
