...
class BmpPixbuf
{
	public:
		...
		inline const std::vector<unsigned char> & get_data() const
		{
			return this->data;
		}

		inline size_t get_len_row() const
		{
			return this->len_row;
		}
		inline size_t get_len_pixel() const
		{
			return this->len_pixel;
		}
...
class BmpImg : public BmpPixbuf
{
	public:
		...
		int get_width (void);
		int get_height (void);
		int get_padding() const { return _padding; }
