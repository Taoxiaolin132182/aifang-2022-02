...
#         for line_child in lines.split("\n")[0].split(" * "):
#             data_lines.append(line_child)
#     random.shuffle(data_lines)
#     batch_num = int(len(data_lines) / (2 + 6))
#     with open(file_name, 'w') as f:
#         for i in range(batch_num):
#             line = data_lines[i * 8 + 0]
#             for j in range(2 - 1):
#                 line = line + " * " + data_lines[i * 8 + 1 + j]
#             f.write(line)
#             f.write("\n")
#
#             line = data_lines[i * 8 + 2 + 0]
#             for j in range(6 - 1):
#                 line = line + " * " + data_lines[i * 8 + 2 + 1 + j]
#             f.write(line)
#             f.write("\n")
#     print("shuffle data over")
