...
class yolov3_trt(object):
    ...
    def loss_layer(self, feature_map_i, y_true, anchors):
        ...
        conf_loss_pos_ = conf_pos_mask * focal_loss(pred_conf_logits, object_mask, alpha=0.25, gamma=2)
        conf_loss_neg_ = conf_neg_mask * focal_loss(pred_conf_logits, object_mask, alpha=0.25, gamma=2)
        conf_loss_ = tf.reduce_sum(conf_loss_pos_ + conf_loss_neg_) / N
        conf_loss = conf_loss + conf_loss_*10.0  # 10.0
        ...
        return xy_loss, wh_loss, conf_loss*1.0, class_loss*1.0
