...
savedmodel_dir = "./yolov3_model_sjht_classify"
img_ori = cv2.imread("/media/data/trt_model/YOLOv3_TensorFlow/find.jpg")
img = cv2.resize(img_ori, tuple([192, 192]))
...
write_graph_to_file("yolov3_sjht_fp16_classfipy.pb", trt_graph_fp16, "./trt_model")
...
#write_graph_to_file("yolov3_sjht_int8_classfipy.pb", trt_graph, "./trt_model")
