...
class Logger:
    def __init__(self, log_save_dir, save_log_num=7):
    ...
    def build_logger(self):
        ...
        log_save_file_name = os.path.join(self.log_save_dir, build_time + "_aiInfer.log")
    ...
    def find_log_file(self, parent_dir):
        ...
        def find_all_file_(parent_dir):
            if os.path.isdir(parent_dir):
                ...
                if parent_dir.split("_")[-1] == "aiInfer.log":
