# coding=utf-8
'''(2021-08-18) - (试生产-1.2A) - (4抓手) - (ARM1) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 1  # ARM 1号
Path_upload = "wxyf_1.2A_arm1_"  # 上传图片路径标记
...
X1_LEN1 = [110, 110, 0]             # 抓手1的X轴距离补偿
Y1_LEN1 = [820, 820, 0]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.58, 0.58, 0]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [100, 100, 0]             # 抓手2的X轴距离补偿
Y2_LEN1 = [1420, 1420, 0]       # 抓手2的Y轴距离补偿
T2_LEN1 = [0.65, 0.65, 0]       # 抓手2的下抓时间补偿

X3_LEN1 = [90, 95, 0]              # 抓手3的X轴距离补偿
Y3_LEN1 = [2320, 2320, 0]     # 抓手3的Y轴距离补偿
T3_LEN1 = [1.84, 1.84, 0]        # 抓手3的下抓时间补偿

X4_LEN1 = [85, 85, 0]               # 抓手4的X轴距离补偿
Y4_LEN1 = [2920, 2920, 0]      # 抓手4的Y轴距离补偿
T4_LEN1 = [1.78, 1.78, 0]         # 抓手4的下抓时间补偿

Speed_of_csd = 437  #传送带速度 500mm/s
Speed_rate = 0.19  # 传送带速度比率：试生产1.1  20hz
Min_value_X = 30  # 抓取限位X最小
Max_value_X = 1170  # 抓取限位X最小
...
Throw_location = [1300, 1300, 1300, 1300]  # 各抓手的抛料位的x值[1号抓手，2号，3号，4号，](分段：0/600; 正常 2200)
...
Camera_id = [["48024031", "A", "1"],
             ["48024039", "B", "2"]]  # 试生产1.2A-ARM1 对应相机号
