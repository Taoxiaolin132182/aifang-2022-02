...
Frame_time = 0.55  # 拍照间隔时长(秒) - 生产者循环中
...
Throw_location = [0, 600, 0, 600]  # 各抓手的抛料位的x值[1号抓手，2号，3号，4号，](分段：0/600; 正常 2200)
