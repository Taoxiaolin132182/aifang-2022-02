# coding=utf-8
'''(2022-02-21) - (无锡远纺1.1-老版本) - (2抓手) - (ARM2) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 2  # ARM 2号
Path_upload = "wxyf_old1.1_arm2_"  # 上传图片路径标记
Code_version = 4.2
...
Update_times = 6  # 上传频率 次数  (上传快：6  || 慢：60)
...
X1_LEN1 = [-16, -16, -16]             # 抓手1的X轴距离补偿
Y1_LEN1 = [45, 45, 45]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.45, 0.45, 0.45]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [0, 0, 0]             # 抓手2的X轴距离补偿
Y2_LEN1 = [693, 693, 693]       # 抓手2的Y轴距离补偿
...
Speed_of_csd = 195  # 传送带速度 600mm/s(预设)
Speed_rate = 0.03676  # 传送带速度比率：无锡远纺1.1  53hz
Min_value_X = 231  # 抓取限位X最小(基于传送带边缘)
Max_value_X = 1961  # 抓取限位X最大(基于传送带边缘)
...
# Camera_id = [["39024067", "A", "1"],
#              ["39024071", "C", "2"],
#              ["39024068", "B", "3"]]  # 无锡远纺1.1A-ARM2 对应相机号
