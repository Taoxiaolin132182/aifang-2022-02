# coding=utf-8
'''(2022-02-17) - (无锡远纺1.1-老版本) - (2抓手) - (ARM1) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 1  # ARM 1号
Path_upload = "wxyf_old1.1_arm1_"  # 上传图片路径标记
Code_version = 4.2
...
X1_LEN1 = [0, 0, 0]             # 抓手1的X轴距离补偿
Y1_LEN1 = [-40, -40, -40]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.47, 0.47, 0.47]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [0, 0, 0]             # 抓手2的X轴距离补偿
Y2_LEN1 = [670, 670, 670]       # 抓手2的Y轴距离补偿
T2_LEN1 = [0.55, 0.55, 0.55]       # 抓手2的下抓时间补偿
...
# Camera_id = [["13024367", "A", "1"],
#              ["12024382", "C", "2"],
#              ["13024376", "B", "3"]]  # 无锡远纺1.1A-ARM1 对应相机号
...
PLC_ip_frist = '192.168.1.250'  # 第一抓取模组  --ssc-1.1-0915
