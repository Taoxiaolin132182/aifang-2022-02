...
X1_LEN1 = 0 -16 #抓手1的Y轴距离补偿
Y1_LEN1 = 0 + 25 #抓手1的Y轴距离补偿
T1_LEN1 = -0.15 #抓手1的下抓时间补偿
X2_LEN1 = 8 -9 #抓手1的Y轴距离补偿
Y2_LEN1 = 628 - 25  #抓手2的Y轴距离补偿
T2_LEN1 = -0.15 #抓手2的下抓时间补偿
