...
class point_record:
    def __init__(self):
        ...
        self.use_1claw_PLC_throw = 0  # 抓手1 PLC异常 丢失的点
        self.use_2claw_PLC_throw = 0  # 抓手2 PLC异常 丢失的点
        # =============================================
        ...
        self.use_2claw_check_NG_from_q2 = 0  # 抓手2 舍去 存入次队列-总 -从次队列
        self.use_2claw_check_NG_1_from_q2 = 0  # 抓手2 舍去 -异纤 优先 -从次队列
        self.use_2claw_check_NG_2_from_q2 = 0  # 抓手2 舍去 -其他异常点 -从次队列
        self.use_2claw_check_NG_3_from_q2 = 0  # 抓手2 舍去 -异纤 疑似 -从次队列
        ...
        self.supplier_bool = False #True 为 可以录入
        #棉花厂供应商
        self.supplier = [
            ['武城发洋',	'37050', 'WC-FY1'],
            ['武城银海', '37087', 'WC-YH1'],
