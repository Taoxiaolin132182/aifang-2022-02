    ...
    def filter(self, aoContext):
        ...
        if aoContext.point_id <= 0:
            ...
            strSql = (
                      ...
                      "(`take_photo_id`,`image_id`,`type`,`ff_color`,`ff_type`,`batch_no`,`threshold`,`level`,`speed`,"
            ...
            oValues = (aoContext.take_photo_id, aoContext.image_id, aoContext.type, aoContext.ff_color,
                       aoContext.ff_type, aoContext.batch_no, aoContext.threshold, aoContext.level, aoContext.speed,
            ...
            strSql = (
                      ...
                      "SET `take_photo_id`=%s,`image_id`=%s,`type`=%s,`ff_color`=%s,`ff_type`=%s,`batch_no`=%s,`threshold`=%s,"
