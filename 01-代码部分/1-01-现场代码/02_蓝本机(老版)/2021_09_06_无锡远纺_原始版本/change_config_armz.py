...
'''(2021-06-11) - (试生产) - (2.0+1.0+4抓手) - (ARM1) 模组配置'''


'''此模块特征(不同主机，会有不同)'''
ARM_number = 1  # ARM 1号
Path_upload = "ssc_1.1_arm1_"  # 上传图片路径标记
...
Need_time_PLC = 2  # ARM1连接的是新的PLC，用[2]
'''数据相关'''
# 程序选择AI返回的label种类
...
PQ_T = 0.2
# 抓手偏移量
X1_LEN1 = 0          # 抓手1的X轴距离补偿
Y1_LEN1 = 0            # 抓手1的Y轴距离补偿
T1_LEN1 = 0.65 - 0.4   # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = -15           # 抓手2的X轴距离补偿
Y2_LEN1 = 583      # 抓手2的Y轴距离补偿
T2_LEN1 = 0.6 - 0.4  # 抓手2的下抓时间补偿

X3_LEN1 = 30            # 抓手3的X轴距离补偿
Y3_LEN1 = 1120            # 抓手3的Y轴距离补偿
T3_LEN1 = 0           # 抓手3的下抓时间补偿

X4_LEN1 = 40            # 抓手4的X轴距离补偿
Y4_LEN1 = 1703            # 抓手4的Y轴距离补偿
T4_LEN1 = 0         # 抓手4的下抓时间补偿
...
PLC_ip_frist = '192.168.1.102'  # 第一抓取模组
PLC_ip_second = '192.168.1.250'  # 第二抓取模组
PLC_port = 10002  # PLC端口号
PLC_ctrl_choose = [1, 1, 1]  # 选择要连接的PLC模块
