# coding=utf-8
'''(2021-09-12) - (试生产-1.1-NO.2) - (4抓手) - (ARM2) 模组配置'''

'''此模块特征(不同主机，会有不同)'''
ARM_number = 2  # ARM 2号
Path_upload = "ssc_1.1.2_arm2_"  # 上传图片路径标记
...
X1_LEN1 = [10, 25, 15]             # 抓手1的X轴距离补偿
Y1_LEN1 = [0, 0, 0]             # 抓手1的Y轴距离补偿
T1_LEN1 = [0.3, 0.36, 0.33]       # 抓手1的下抓时间补偿(减去的时间，值越大，下抓时刻越早)

X2_LEN1 = [0, 35, 10]             # 抓手2的X轴距离补偿
Y2_LEN1 = [635, 580, 575]       # 抓手2的Y轴距离补偿
T2_LEN1 = [0.2, 0.14, 0.09]       # 抓手2的下抓时间补偿
...
Speed_rate = 0.0656  # 传送带速度比率：试生产1.1  25hz -2021-0928
Min_value_X = 273  # 抓取限位X最小
Max_value_X = 1973  # 抓取限位X最小
...
Camera_id = [["30124935", "A", "1"],
             ["30124942", "C", "2"],
             ["30125170", "B", "3"]]  # 试生产1.1-UV-ARM1 对应相机号
...
PLC_ctrl_choose = [0, 1, 0]  # 选择要连接的PLC模块
