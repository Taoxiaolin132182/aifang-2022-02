...
logger6 = logging.getLogger('r2temp')
...
def test_takepic(run_service):
    try:
        ...
        while True:
            ...
            if not bResult:
                cam_err += 1
                if aiCottonConfig.CAMERA_DEVICE_TUPLE[0] in cam_id:
                    cam_A += 1
                if aiCottonConfig.CAMERA_DEVICE_TUPLE[1] in cam_id:
                    cam_C += 1
                if aiCottonConfig.CAMERA_DEVICE_TUPLE[2] in cam_id:
                    cam_B += 1
